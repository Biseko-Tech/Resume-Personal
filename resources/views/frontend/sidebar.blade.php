<div class="sidebar">
    <div class="sidebar-header">
        <img src="{{ asset($home->person_photo) }}" alt="Image">
    </div>
    ...
    <div class="sidebar-footer">
        ...
        <a href="https://web.facebook.com/fortubiseko/" target="_blank"><i class="fab fa-facebook-f"></i></a>
        <a href="https://www.instagram.com/fbiseko/" target="_blank"><i class="fab fa-instagram"></i></a>
    </div>
</div>