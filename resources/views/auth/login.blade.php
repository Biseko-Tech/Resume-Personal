                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        <input type="email" class="form-control input-lg" name="email" id="email" aria-describedby="emailHelp" placeholder="Email" required autofocus>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex my-2 justify-content-between">
                                            <div class="d-inline-block mr-3">
                                                <label for="remember_me" class="control control-checkbox">Remember me
